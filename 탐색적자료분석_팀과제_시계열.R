...
#철도이용객수와 관광객수의 증감이 같다고 가정하고 철도이용객 수에 대해  각 요인별 효과를 알아보기 위해 중간값 다듬기를 진행함.
...
# 잔차를 확인해본 결과 날씨가 가장 좋은 4월~7월에 남이섬 유원지가 가장 높은것이 확인되었고, 스키장의 경우 겨울인 1,2, 12월에 가장 높게 나타난것이 확인됨
...
# 행효과 : 확진자의 수가 많지않았던 1월에는 코로나 이전과 행 효과가 비슷하게 나타났지만 본격적으로 코로나 바이러스가 시작된 2월이후에는 급격하게 줄어들은 것을 확인할 수 있었다. 이후 코로나사태가 잠시 진정되었던 7월과 10월에는 증가하였다가 하루 평균 확진 1000명대를 기록한 12월에는 다시 급격하게 줄어든것이 확인됨.
